<div class="posts index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('num_replies');?></th>
			<th><?php echo $this->Paginator->sort('last_reply_date');?></th>
	...
	<tr>
		...
		<td><?php echo h($post['Post']['num_replies']); ?>&nbsp;</td>
		<td><?php echo h($post['Post']['last_reply_date']); ?>&nbsp;</td>
